"""Fetch unmodified CC0 palace material maps and retain source/hash records."""
import hashlib
import json
import pathlib
import subprocess
...
SOURCE = ROOT / "asset-sources/palace-materials"
SOURCE.mkdir(parents=True, exist_ok=True)
jobs = []
for asset, local, size in [
    ("marble_rock_02", "palace-stone", "2k"),
    ("blue_plaster_weathered", "palace-plaster", "2k"),
    ("marble_mosaic_tiles", "palace-mosaic", "2k"),
]:
