...
The coastal sluices also have [masonry foundations fitted to the well floors](docs/sluice-foundations.md),
supporting the walls and wider gate posts exposed by diving and drainage.
...
The [ferry construction update](docs/courier-construction.md) adds weathered
timber, grooved wheels, fitted stone and a woven sail that gathers upward as you
brake. Its rigging and positioned wind follow the moving cloth.
...
The coastal chapter’s third field mission now repairs [the coral pump](docs/coral-pump.md). Recover its impeller, read the pumpkeeper’s diagram and install the part, then adjust the intake and bypass wheels to hold steady pressure. The turning rotor, gauge and outflow show the repair in the world; installed parts and valve settings persist.
