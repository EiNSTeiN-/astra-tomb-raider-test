...
| VA-03 | Waterfall landmarks read as narrow freestanding slabs with an unconvincing water source and receiving area. | All nine structures now have [supplied header reservoirs, regional crowns, deep supports and three lit spill channels](supplied-cascades.md). Traversal and positional sound checks pass. Angular receiving-pool boundaries remain visible, especially in the cloud city; basin and terrain construction still need work. | Open |
