...
| VA-20 | The portrait resonance inspection view clips part of array 5's rightmost crystal. | The [390×844 inspection capture](images/regional-banks/portrait-array.webp) retains the node centres, but the outer silhouette reaches beyond the image. Fit the complete array within the inspection lens and preserve room for its controls. | Open; portrait framing |
