...
| VA-15 | Initial routes contain repeated steep-sided terrain mounds with abrupt shoulders and broad flat faces. | The [regional bank pass](regional-banks.md) widens and varies the enclosing path slopes in all five affected chapters while retaining every walking-grid height. Verification covers 643 tests, ten assisted route legs, all 47 affected main courts, dependent roots/foundations, sound paths and ten native production cases. Fixed court terraces still have abrupt cuts, including the rear snow courts and front crystal courts. | Open; path banks improved, court terraces remain |
...
| VA-17 | First-court crystal and eclipse pools show conspicuous straight water-sheet edges against the terrain. | All fourteen desert/crystal/eclipse court pools had exposed outer borders. [Regional pool shores](court-pools.md) bury those borders, reshape their banks and fit water levels to neighboring terraces. Verification includes 5,656 terrain rays, 42 reviewed views, swimming and nearby control routes, positioned audio and eight native production cases. | Fixed |
| VA-18 | A resonance instrument obscures the explorer while swimming back into the last crystal court pool. | The camera treated a target inside its expanded safety margin as being inside the solid and ignored the obstruction. [Swimming camera clearance](swimming-camera.md) repairs that distinction and keeps the view direction smooth through full retraction. Verification covers 3,040 pool movement frames, eight chapter regressions, related aiming/torch/reflection states and four native production cases with independently checked reload corrections. | Fixed |
| VA-19 | Jungle tree scans expose some lower root margins above sloped terrain. | The [regional bank review](regional-banks.md#remaining-observations) records a visible margin near the first approach and a 1.09 m sampled gap at the tree near (101.67, 66.01). A lower-trunk screening pass identifies 374 of 753 instances with a margin above 20 cm; individual root geometry and reachable views need inspection. | Open; jungle tree placement |
| VA-20 | The portrait resonance inspection view clips part of array 5's rightmost crystal. | The [array-framing repair](resonance-framing.md) fits complete built geometry around the actual controls, uses a stacked layout on portrait tablets, and separates long titles from the close button. Geometry, roof clearance, 64 browser views and native tuning/reload checks verify the repair. | Fixed |
| VA-21 | A touch Use gesture can activate Reset after opening a resonance inscription, clearing restored tuning. | The [touch interaction repair](resonance-framing.md#touch-interaction-repair) consumes the generated click from an already handled control press. The reproduced second-array case retains its saved mark, while a separate intentional Reset tap works. | Fixed |
...
| VA-23 | The assisted snow bell-control view is obstructed by timber above the instrument. | The [chapter dialog review](dialog-notices.md) records the obstruction at the second bell court in desktop and portrait views. Inspect the focus camera against the current sanctuary geometry and reproduce through native interaction. | Open; bell inspection camera |
