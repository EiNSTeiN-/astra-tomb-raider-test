...
The sky chapter's suspension bridges, folding plank decks, cables, and safety tether are original code-generated geometry. They reuse the existing local monastery wood and bark materials. Their creaking is synthesized by project code; no new third-party visual or audio files were added for these bridges.
