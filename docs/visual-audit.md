...
| VA-15 | Initial routes contain repeated steep-sided terrain mounds with abrupt shoulders and broad flat faces. | The [regional bank pass](regional-banks.md) widens the enclosing path slopes. The subsequent [court terrain pass](court-terrain.md) grades overlapping pads in all five affected chapters, reducing four recorded snow/crystal transitions from 2.09–6.83 m to 0.37–0.86 m per 1.75 m interval. Verification covers 658 tests, ten longer route legs, eight direct crossings, all 47 affected main courts, roots/foundations, sound paths and ten native production cases. A protected discovery-pad overlap beside snow court 7 retains a visible 4.34 m bank over 1.75 m. | Open; path banks and shared court joins improved, protected overlap remains |
