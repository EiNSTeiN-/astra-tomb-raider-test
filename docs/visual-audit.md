...
| VA-22 | A transient chapter-narration toast overlaps the resonance scene or controls soon after a reload. | The [production inspection review](resonance-framing.md) records overlap in portrait views, including the [320×480 control panel](images/resonance-framing/narration-overlap.webp). Give narration a place that preserves the scene and working controls. | Open; narration layout |
