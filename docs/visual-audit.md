...
| VA-18 | A resonance instrument obscures the explorer while swimming back into the last crystal court pool. | The [pool production review](court-pools.md) records the High return-swim view. Reproduce the camera sweep at crystal reservoir 7 and check instrument obstruction bounds and immersed camera targets. The separately verified arrival-camera correction does not resolve this ordinary-play view. | Open; swimming camera |
