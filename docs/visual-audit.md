...
| VA-16 | A tree base appears suspended above the snow approach. | The [route capture and observer coordinates](initial-court-routes.md) record the gap. Inspect the tree transform, base geometry, terrain contact and visibility transitions to establish its cause. | Open; placement investigation |
