...
function init() {
  document.querySelector("#app").innerHTML = `
    ...
    <section id="game-screen" class="hidden" aria-label="Vesper adventure"><div id="game-canvas"></div><div class="game-vignette"></div><div id="damage-flash"></div>
      ...
      <div class="crosshair" aria-hidden="true"><span></span><span></span><i></i></div><div id="aim-status" class="aim-status" role="status"></div><div class="sense-label hidden" id="sense-label">${icon("Eye")} EXPLORER’S INSTINCT</div><div id="waypoint" class="waypoint">◇<span></span></div>
