"""Fetch unmodified CC0 forge material maps and retain source/hash records."""
import hashlib
import json
import pathlib
import subprocess
...
SOURCE = ROOT / "asset-sources/forge-materials"
SOURCE.mkdir(parents=True, exist_ok=True)
jobs = []
for asset, local, size in [
    ("rock_face_03", "forge-rock", "2k"),
    ("rusty_metal_04", "forge-metal", "2k"),
    ("volcanic_rock_tiles", "forge-paving", "2k"),
]:
    ...
    channels = [("Diffuse", "color"), ("nor_gl", "normal"), ("Rough", "roughness")]
    if local == "forge-metal":
        channels.append(("Metal", "metalness"))
