...
| VA-05 | Repeated plain rear walls and sparse surrounding ground weaken the identity of many courts. | [Regional chamber walls](chamber-walls.md) now give 35 coastal, volcanic, crystal and eclipse chambers 105 detailed outer faces with real recesses, regional surrounds and framed interior panels. The review covers wall/interior views, opening states, footing and camera depth, nearby movement and sound paths. Repeated chamber footprints and sparse surroundings still need composition work, followed by broader approach/return coverage. | Open; wall treatment improved |
...
| VA-14 | The Low air-bell ceiling view has a rectangular, banded highlight above its lamp. | The [close-camera gallery check](close-camera.md) exposes the highlight in the first air bell. The camera and full character coverage restore correctly. Inspect the ceiling material, lamp and rendering at both settings to determine the cause before changing geometry or shading. | Open; rendering investigation |
