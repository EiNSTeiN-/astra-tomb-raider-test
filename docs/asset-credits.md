...
The [frozen stair](frozen-stair.md), its broken service gallery, ice locks, hauling
wheel, guide cables and signs are original geometry and writing in
`src/frozen-stair*.js`. They reuse those monastery materials and the existing
original hoist synthesis. No external assets, recordings or music were added.

The [eastern reflector](eastern-reflector.md), its timber back, metal plates,
service gallery, stone gantry, hauling tackle and signs are original project
geometry and writing in `src/eastern-reflector*.js`. They reuse existing local
sandstone and timber materials, project metal/rope materials and the original
hoist synthesis. No external assets, recordings, music or dependencies were added.

The [rain garden](rain-garden.md), its irrigation terrace, turnable channels,
stair, waterwheel, cargo lift and signs are original project geometry and code in
`src/rain-garden*.js`. They reuse the credited temple and timber materials,
existing project bronze/rope materials, the local waterfall recording and the
original hoist synthesis. Its flow surfaces reuse the project's spillway
shaders. No external assets or dependencies were added.

The garden's [construction artwork](rain-garden-construction.md), including
fitted paving, timber trusses and shingles, segmented wheel rims and buckets,
grooved pulley, mounted signs and carved control plinths, is original project
geometry in `src/rain-garden-art.js` and `src/rain-garden.js`. It reuses the
project's fitted-stone generator, temple/timber materials and worn bronze
shader. No new textures, external assets, recordings or dependencies were added.
