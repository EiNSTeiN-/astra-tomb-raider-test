...
| VA-09 | Resuming at a close solar control can leave the camera obscured by a handwheel or adjacent receiver column. | Observed in production input checks at chamber 5's last mirror near world coordinates 58.35, 221.15. Turning and saved progress work; the cramped initial view needs orbiting or movement into the aisle. Inspect approach and resume orientations and improve camera clearance. [Mount verification notes](solar-mounts.md) describe the separate finding. | Open |
